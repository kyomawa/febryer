...
const CredenzaBody = ({ className, children, ...props }: CredenzaProps) => {
  return (
    <div
      className={cn(
        "max-h-[75vh] overflow-y-auto px-4 md:px-[2px] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-neutral-200 dark:[&::-webkit-scrollbar-thumb]:bg-primary-200/65 [&::-webkit-scrollbar]:w-1.5",
        className
      )}
      {...props}
    >
