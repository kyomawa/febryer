...
const inputVariants = cva(
  "flex h-10 w-full rounded-md px-3 py-2 sm:text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
        ...
        datatableFilter: "bg-primary-700/10 placeholder:text-primary-800/65 text-neutral-900 pl-10",
        datatableCell: "hover:bg-white bg-white/0 transition-colors duration-200 ease-in-out",
        docsCreation: "w-full h-auto rounded-none bg-transparent cursor-pointer dark:placeholder:text-primary-100/50",
